package com.location.xclusive_pc.locationmanager;
...
/**
 * Created by XCLUSIVE-PC on 1/27/2017.
 */

public class LocationAcess extends Service implements LocationListener {
    ...
    public LocationAcess(Context context) {
...
// if GPS Enabled get lat/long using GPS Services
                ...
                if (isGPSEnabled) {
                    if (location == null) {
                        locationManager.requestLocationUpdates(
                                LocationManager.GPS_PROVIDER, MIN_TIME_BW_UPDATES, MIN_DISTANCE_CHANGE_FOR_UPDATES, (android.location.LocationListener) this);
                        Log.d("GPS Enabled", "GPS Enabled");
                        if (locationManager != null) {
    ...
    private void requestPermissions(String[] strings, int requestCodeAskPermissions) {
    }
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            ...
            locationManager.removeUpdates((android.location.LocationListener) LocationAcess.this);
        }
    }
